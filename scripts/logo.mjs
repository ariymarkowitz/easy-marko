...
// over "Markdown editor". Text is outlined, so rendering needs no fonts. Run
// scripts/icons.mjs and scripts/og-image.mjs afterwards for the PNGs.
//
