...
- `scripts/`: development scripts (`server.mjs` lists and stops this folder's local servers; `icons.mjs` regenerates the PNG icons from `public/icon.svg`; `banner.mjs` generates `public/welcome-banner.svg`).
